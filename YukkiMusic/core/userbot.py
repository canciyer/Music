        ...
        if config.STRING1:
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, "⭐️ 1-ci Asistan Aktif"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.send_message(
                    config.LOG_GROUP_ID, "⭐️ 2-ci Asistan Aktif"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                await self.three.send_message(
                    config.LOG_GROUP_ID, "⭐️ 3-cü Asistan Aktif"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.send_message(
                    config.LOG_GROUP_ID, "⭐️ 4-cü Asistan Aktif"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                await self.five.send_message(
                    config.LOG_GROUP_ID, "⭐️ 5-ci Asistan Aktif"
                )
            except:
                LOGGER(__name__).error(
